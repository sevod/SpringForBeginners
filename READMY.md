...
Подключаем спринг к проекту. ПКМ на верхней папке проекта и "Add Framework support". Если через мавен "Hibernate Core Relocation 5.4.21", "Hibernate Commons Annotations"

В мавен добавляю `MySQL Connector/J » 8.0.23`

Заполняем файл hibernate.cfg.xml из прикрепленного файла(копи паст). 
